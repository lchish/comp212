...
<html>
  <head>
    ...
    <script type="text/javascript" src="newaccount.js"></script>
...
?>
	...
	<div class="textinput">
	  ...
	  <input id="username" name="username" class="textfield"
		 maxlength="32" size="20"><div id="usernameerr" class="error">
	  </div>
	  ...
	  <input type="radio" id="female" name="sex" value="female" 
		 class="radiobutton"><div id="sexerr" class="error"></div>
